  ...
  return (
    <div className="grid gap-5">
      ...
      <section className="grid gap-4 xl:grid-cols-2">
        <GlassCard><h2 className="mb-4 flex items-center gap-2 font-semibold"><Users size={18} /> Users and Roles</h2><DataTable columns={["User", "Role", "Rail Network", "Status"]} rows={[["Plant Manager", "Admin", "Rail Corridor A", <SeverityBadge key="a" value="Approved" />], ["Reliability Engineer", "Engineer", "Rail Corridor A", <SeverityBadge key="b" value="Approved" />], ["Compliance Auditor", "Auditor", "Rail Corridor A", <SeverityBadge key="c" value="Needs Review" />]]} /></GlassCard>
