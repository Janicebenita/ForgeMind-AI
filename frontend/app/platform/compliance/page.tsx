  ...
  return (
    <div className="grid gap-5">
      <section className="command-panel rounded-3xl p-6">
        ...
        <p className="mt-2 max-w-3xl text-slate-400">Rail safety, operating, environmental, quality, inspection, and internal procedure evidence mapped to assets and controls.</p>
      </section>
      ...
      <section className="grid gap-4 md:grid-cols-3">
        ...
        <GlassCard><FileWarning className="mb-4 text-amber-300" /><h3 className="font-bold">Missing Evidence</h3><p className="mt-2 text-sm leading-6 text-slate-400">TRK-003 pressure test evidence, EP501 rail electrical safety updates, and BRG-004 inspection closure need owners.</p></GlassCard>
