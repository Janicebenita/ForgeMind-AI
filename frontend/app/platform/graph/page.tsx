  ...
  return (
    <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
      ...
      <aside className="grid h-fit gap-4">
        <GlassCard><h2 className="mb-3 font-semibold">Selected Node</h2><p className="text-xl font-bold">TRK-001</p><p className="text-sm text-slate-400">Mainline Track Section A · Unit A</p><div className="mt-4"><SeverityBadge value="Critical" /></div></GlassCard>
